...
- 開發者有權隨時更新服務條款，並會在網站上公佈最新版本。您應定期查閱服務條款更新，並使用本程式即表示同意接受最新版本。
...
- 使用本程式的風險由用戶自行承擔，開發者不對因使用本程式而產生的任何損失或損害負責。

### ®️ 知識產權

- 本軟體及其相關內容（包括但不限於代碼、設計、圖標）受版權法保護，未經授權禁止複製、修改或散佈。
- 本程式可能包含來自第三方的內容或資源，這些內容的版權歸原提供者所有，並受到其相應的條款約束。
